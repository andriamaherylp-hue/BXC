...
export const MARKET_DATA={
  crypto:[
    {code:'BTC/USDT',symbol:'BTC',name:'Bitcoin',price:64791.99,change:1.46,image:btc,accent:'orange',spark:line(40,42,44,50,51,49,54,55,54,53,55)},
    ...
    {code:'DOGE/USDT',symbol:'DOGE',name:'Dogecoin',price:.07021,change:-.16,image:doge,accent:'gold',spark:line(45,44,43,46,51,53,52,50,49,50,49)},
    ...
    {code:'XLM/USDT',symbol:'XLM',name:'Stellar',price:.1549,change:-1.84,image:xlm,accent:'black',spark:line(47,46,45,47,49,48,46,43,44,42,40)},
    {code:'DOT/USDT',symbol:'DOT',name:'Polkadot',price:.733,change:-4.31,image:dot,accent:'pink',spark:line(56,51,49,46,42,43,45,46,44,45,43)},
    ...
    {code:'UNI/USDT',symbol:'UNI',name:'Uniswap',price:3.718,change:-.47,image:uni,accent:'pink',spark:line(52,49,47,45,46,43,41,43,44,46,45)},
  ],
  forex:[
    {code:'GBP/USD',symbol:'GBPUSD',name:'GBP/USD',price:1.35381,change:.03,image:gbpusd,accent:'flag',spark:line(40,43,44,46,48,47,48,49,50,50,51)},
    ...
    {code:'EUR/USD',symbol:'EURUSD',name:'EUR/USD',price:1.15779,change:.04,icon:'🇪🇺🇺🇸',accent:'flag',spark:line(40,43,45,46,44,48,49,50,49,51,52)},
    ...
    {code:'USD/HKD',symbol:'USDHKD',name:'USD/HKD',price:7.84403,change:-.01,icon:'🇺🇸🇭🇰',accent:'flag',spark:line(44,44,45,46,47,47,48,49,50,51,54)},
    {code:'USD/CNY',symbol:'USDCNY',name:'USD/CNY',price:6.74597,change:.02,icon:'🇺🇸🇨🇳',accent:'flag',spark:line(43,55,42,49,44,48,45,49,50,47,49)},
    ...
    {code:'CAD/USD',symbol:'CADUSD',name:'CAD/USD',price:1.38913,change:.13,image:cadusd,accent:'flag',spark:line(40,42,44,47,49,52,51,53,54,52,53)},
  ...
  stocks:[
    {code:'TSLA',symbol:'TSLA',name:'Tesla',price:337.04,change:-.67,image:tsla,accent:'red',spark:line(52,49,50,48,46,47,45,44,43,45,44)},
    ...
    {code:'GOOGL',symbol:'GOOGL',name:'Google',price:343.31,change:-.20,image:googl,accent:'google',spark:line(48,47,49,46,48,47,46,44,43,44,42)},
    ...
    {code:'MSFT',symbol:'MSFT',name:'Microsoft',price:482.153,change:.38,image:msft,accent:'blue',spark:line(42,45,44,48,50,49,52,53,51,54,52)},
    {code:'ORCL',symbol:'ORCL',name:'Oracle',price:143.415,change:-2.21,icon:'ORCL',accent:'red',spark:line(52,50,48,47,45,43,41,42,40,39,38)},
    {code:'JPM',symbol:'JPM',name:'JPMorgan',price:360.82,change:-.04,icon:'JPM',accent:'blue',spark:line(47,48,46,47,45,44,46,45,44,43,43)},
    ...
    {code:'JNJ',symbol:'JNJ',name:'Johnson & Johnson',price:270.21,change:2.99,icon:'JNJ',accent:'red',spark:line(40,45,48,43,49,52,47,51,50,53,54)},
    {code:'PLTR',symbol:'PLTR',name:'Palantir',price:171.835,change:-.41,icon:'◒',accent:'black',spark:line(49,48,50,47,46,44,43,42,43,41,40)},
    {code:'PG',symbol:'PG',name:'P&G',price:143.97,change:.59,icon:'PG',accent:'blue',spark:line(40,42,45,48,50,52,51,53,55,54,56)},
  ],
  futures:[
    ...
    {code:'XNG',symbol:'XNG',name:'Natural Gas',price:2.729,change:-.18,icon:'🔥',accent:'blue',spark:line(44,46,49,50,52,50,47,45,46,45,44)},
    {code:'XAL',symbol:'XAL',name:'Aluminium',price:3215.13,change:.02,icon:'Al',accent:'silver',spark:line(48,49,48,50,49,50,51,49,50,48,49)},
    {code:'XCU',symbol:'XCU',name:'Copper',price:13968.44,change:-.02,icon:'Cu',accent:'copper',spark:line(50,49,48,47,48,46,45,44,43,44,42)},
    {code:'XPD',symbol:'XPD',name:'Palladium',price:1291.57,change:-.17,icon:'Pd',accent:'silver',spark:line(50,48,46,45,44,42,43,41,42,40,41)},
    {code:'XPT',symbol:'XPT',name:'Platinum',price:1728.69,change:-.11,icon:'Pt',accent:'silver',spark:line(48,46,45,43,42,40,41,42,44,45,43)},
    ...
    {code:'XNI',symbol:'XNI',name:'Nickel',price:16754.28,change:-.28,icon:'Ni',accent:'silver',spark:line(51,49,48,47,45,44,43,42,41,40,39)},
    {code:'XPB',symbol:'XPB',name:'Lead',price:1885.25,change:-.02,icon:'Pb',accent:'silver',spark:line(47,46,45,44,43,42,41,42,41,40,40)},
    {code:'XZN',symbol:'XZN',name:'Zinc',price:3691.07,change:-.15,icon:'Zn',accent:'silver',spark:line(48,47,46,44,45,43,42,41,40,42,41)},
  ]
}
